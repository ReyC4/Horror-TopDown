<p align="center">
  <img width="100%" alt="prostir" src="https://github.com/user-attachments/assets/c9211700-b3d1-44d1-99b5-baa20c8000d0">
  </br>
</p>
...
## ▶️ Video Gameplay
<img src="https://github.com/ReyC4/ReyC4/blob/main/GIF/Dark.gif" alt="1" style="width:50%;height:auto;">
...
|:-|:-|:-|
| Game Programmer - Main Mechanic | Reynata | 2 Week |
| Game Programmer - Game Mechanic | Reynata | 2 Week |
| Game Artist - 2D Artist Character | Andhika | 1 Week |
| Game Artist - Background Artist | Nathan | 1 Week |
...
```
├── Loo                      # In this Folder, containing all the Unity project files, to be opened by a Unity Editor
   ├── ...
   ├── Assets                         #  In this Folder, it contains all our code, assets, scenes, etcwas not automatically created by Unity
      ├── ...
      ├── Exterior                   # In this folder, there are several packages that you must add via Unity Package Manager
